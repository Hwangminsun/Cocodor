...
<html lang="ko">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
		...
		<!-- <link rel="stylesheer" href="../css/modal.css">  -->
...
<!-- 약관동의시작-->
<h2 class="gaip">회원가입방법</h2>
    <section id="choice">
      
        <div id="play">
          <ul class="aa">
            <li><div class="one1"><img src="../image/etc/accept.png" alt="1.약관동의"></div></li>
            <li><div class="one2"><img src="../image/etc/edit.png" alt="2.정보입력"></div></li>
            <li><div class="one3"><img src="../image/etc/document.png" alt="3.가입완료"></div></li>
          </ul>
          <ul class="bb">
              <li><span>약관 동의</span></li>
              <li><span>정보 입력</span></li>
              <li><span>가입 완료</span></li>
          </ul>
        </div>
    ...
    <section id="ee">
    <form name="j_form" method="post">    
    <fieldset>
    <legend class="title">1&#41; 약관 동의</legend>
        <div id="text_ok">
        <p class="yak">서비스 이용약관
          <span><a href="#" class="full"> 내용보기</a></span></p> 
        <p class="reply"><textarea cols="55" rows="8" name="reply">
인터넷 쇼핑몰 『코코도르(주) 사이버 몰』 회원 약관

제1조(목적)
이 약관은 코코도르(주) 회사(전자상거래 사업자)가 운영하는 코코도르(주) 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
          
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
          
제2조(정의)
① “몰”이란 코코도르(주) 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 코코도르(주) 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
“코코도르”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
          
          
본 약관은 2020년 08월 20일부터 적용됩니다.                                                                                                                                                                                                               
        </textarea></p>
        <span>동의합니다(필수)<input type="checkbox" value="agr" name="agr1"></span>
        


        <p class="yak">개인정보 수집 및 이용<span><a href="#" class="full"> 내용보기</a></span></p>
        <p class="reply"><textarea cols="55" rows="8" name="reply"></textarea></p>
        <span>동의합니다(필수)<input type="checkbox" value="agr" name="agr1"></span>
        
        

        <p class="yak">마케팅 정보 활용<span><a href="#" class="full"> 내용보기</a></span></p>
        <p class="reply"><textarea cols="55" rows="8" name="reply"></textarea></p>
        <span>동의합니다(선택)<input type="checkbox" value="agr" name="agr1"></span>
    ...
    <section id="com">
        ...
        <fieldset>
        <legend class="title">2&#41; 회원정보 입력</legend>
        <ul>
            <li>
        <label for="nick"><span>아이디</span></label></li>
        <li><input type="text" size="15" maxlength="9" placeholder="아이디" id="nick"
		name="id">
        <button type="button" onclick="check_id()">중복확인</button></li>
        
		<li><label for="pwd"><span>비밀번호</span> </label></li>
        <li><input type="password" size="15" maxlength="9"
           id="pwd" name=""pass></li>
        <li><label for="pwd_confirm"><span>비밀번호 확인 </span></label></li>
        <li><input type="password" size="15" maxlength="5" id="pwd_confirm" name="pass_confirm"></li>
        
		<li><label for="irum"><span>이름</span></label></li>
        <li><input type="text" name="name" id="irum"></li>
		
		<!-- <li><span>생년월일</span></li> <li><input type="date"></li> -->

        <li><label for="tel"><span>전화번호</span></label></li>
        <li><input type="tel" pattern="[0-9]{11}" title="하이픈(-)을 넣지 말고 11자리의 전화번호를 입력해주세요" 
            id="tel" required name="hp"></li>
		
		<li><label for="mail"><span>email</span></label></li>
		<li><input type="email" class="email1" name="email" id="mail"></li>
        </ul>
		<div class="clear"></div>
